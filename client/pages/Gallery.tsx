...
export default function Gallery() {
  ...
  if (!context) {
    throw new Error("Gallery must be used within WeddingProvider");
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-serif text-foreground mb-4">Wedding Gallery</h1>
          <p className="text-muted-foreground">
            Capturing the beautiful moments of {weddingData.couple.groomName} & {weddingData.couple.brideName}
          </p>
        </div>

        {weddingData.gallery.length === 0 ? (
          <div className="text-center py-16">
            <h3 className="text-xl font-serif text-foreground mb-2">No photos yet</h3>
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              ...
              {weddingData.gallery[selectedImage].caption && (
                <div className="absolute bottom-4 left-4 right-4 text-center">
                  <p className="text-white bg-black/50 rounded px-4 py-2">
                    {weddingData.gallery[selectedImage].caption}
                  </p>
                </div>
              )}
