         ...
         <div className="max-w-4xl mx-auto px-4">
            <div className="flex flex-col gap-8 md:flex-row md:gap-0 justify-end items-center mb-16">
               <div className="w-full text-center">
                  <Heading heading="Wedding Schedule" subText=" Timeline of our special day" className="mb-0" />
               </div>
               {isLoggedIn && (
                  <Button
         ...
         <Dialog open={isAddingItem} onOpenChange={setIsAddingItem}>
            <DialogContent className="sm:max-w-md">
               ...
               <div className="space-y-4">
                  <div>
                     <label htmlFor="time_input" className="text-sm font-medium mb-2 block">
                        Time
                     </label>
                     <Input
                        id="time_input"
                  ...
                  <div>
                     <label htmlFor="event_input" className="text-sm font-medium mb-2 block">
                        Event
                     </label>
                     <Input
                        id="event_input"
                  ...
                  <div>
                     <label htmlFor="description_textarea" className="text-sm font-medium mb-2 block">
                        Description
                     </label>
                     <Textarea
               ...
               <DialogFooter>
                  ...
                  <Button onClick={addScheduleItem} disabled={!newItem.time || !newItem.event}>
                     Add Item
                  </Button>
               </DialogFooter>
            </DialogContent>
